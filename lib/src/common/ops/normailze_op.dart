...
class NormalizeOp implements TensorOperator {
  ...
  ///
  /// Note: The returned [TensorBuffer] is always a [TfLiteType.kTLiteFloat32] tensor at
  /// present, except that the input is a [TfLiteType.kTLiteFloat32] tensor, [mean] is set to 0 and
  /// [stddev] is set to 1.
  ///
  ///
  ...
  ///
  /// Note: The returned [TensorBuffer] is always a [TfLiteType.kTLiteFloat32] tensor at
  /// present, except that the input is a [TfLiteType.kTLiteFloat32] tensor, all [mean] are set to
  ...
  TensorBuffer apply(TensorBuffer input) {
    ...
    TensorBuffer output;
    if (input.isDynamic) {
      output = TensorBuffer.createDynamic(TfLiteType.kTLiteFloat32);
    } else {
      output = TensorBuffer.createFixedSize(shape, TfLiteType.kTLiteFloat32);
    }
