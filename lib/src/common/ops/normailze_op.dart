...
class NormalizeOp implements TensorOperator {
  ...
  /// present, except that the input is a [TfLiteType.kTfLiteFloat32] tensor, [mean] is set to 0 and
  /// [stddev] is set to 1.
  ///
  ///
  ...
  ///
  /// Note: The returned [TensorBuffer] is always a [TfLiteType.kTfLiteFloat32] tensor at
  /// present, except that the input is a [TfLiteType.kTfLiteFloat32] tensor, all [mean] are set to
  ...
  TensorBuffer apply(TensorBuffer input) {
    ...
    if (input.isDynamic) {
      output =
          TensorBuffer.createDynamic(TfLiteType.kTfLiteFloat32 as TfLiteType);
    } else {
      output = TensorBuffer.createFixedSize(
          shape, TfLiteType.kTfLiteFloat32 as TfLiteType);
    }
