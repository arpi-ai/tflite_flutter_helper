...
void main() {
  ...
  group('tensorbuffer', () {
    group('uint8', () {
      ...
      test('static', () {
        late TensorBuffer tensorBuffer =
            TensorBuffer.createFixedSize([1, 3, 2], TfLiteType.kTLiteFloat32);
        ByteBuffer buffer = Uint8List.fromList([1, 2, 3, 4, 5, 6]).buffer;
        tensorBuffer.loadBuffer(buffer);
        expect(tensorBuffer.getIntList(), [1, 2, 3, 4, 5, 6]);
        expect(tensorBuffer.getDoubleList(), <double>[1, 2, 3, 4, 5, 6]);
    ...
    group('float', () {
      ...
      test('static', () {
        late TensorBuffer tensorBuffer =
            TensorBuffer.createFixedSize([1, 2, 2], TfLiteType.kTLiteFloat32);
        var bdata = ByteData(16);
  ...
  group('common', () {
    ...
    group('ops', () {
      test('normalize', () {
        late TensorBuffer tensorBuffer =
            TensorBuffer.createFixedSize([3], TfLiteType.kTLiteFloat32);
